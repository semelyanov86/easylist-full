...
use App\Actions\Fortify\CustomRedirectIfTwoFactor;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    /**
     * Настройка login pipeline с поддержкой WebAuthn.
     */
    private function configureLoginPipeline(): void
    {
        Fortify::authenticateThrough(fn (Request $request): array => array_filter([
            ...
            Features::enabled(Features::twoFactorAuthentication()) ? CustomRedirectIfTwoFactor::class : null,
    ...
    private function configureViews(): void
    {
        ...
        Fortify::twoFactorChallengeView(fn (Request $request) => Inertia::render('auth/TwoFactorChallenge', [
            'availableMethods' => $request->session()->get('login.2fa_methods', ['totp']),
